...
NSString *const MJRefreshHeaderIdleText = @"加载上月数据";
NSString *const MJRefreshHeaderPullingText = @"松开加载数据";
NSString *const MJRefreshHeaderRefreshingText = @"正在加载";

NSString *const MJRefreshAutoFooterIdleText = @"加载下月数据";
NSString *const MJRefreshAutoFooterRefreshingText = @"松开载入更多";

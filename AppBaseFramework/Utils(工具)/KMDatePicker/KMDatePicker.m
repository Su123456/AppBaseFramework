...
#define kDefaultMaxLimitedDate @"9999-12-31 23:59"
...
- (CGFloat)pickerView:(UIPickerView *)pickerView widthForComponent:(NSInteger)component {
    ...
    switch (_datePickerStyle) {
        ...
        case KMDatePickerStyleYearMonth: {
            widthOfAverage = (kWidthOfTotal - 35.0) / 2;
            switch (component) {
                case 0:
                    width = widthOfAverage;
                    [self addUnitLabel:@"年" withPointX:width/2 + 35.0];
                    break;
                case 1:
                    width = widthOfAverage;
                    [self addUnitLabel:@"月" withPointX:widthOfAverage + width/2 + 28.0];
                    break;
            }
            break;
        }
